...
const Goals = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Overall Stats */}
            <div className="bg-gradient-to-br from-primary to-purple-600 p-8 rounded-2xl shadow-xl text-white">
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="flex flex-wrap gap-2">
                    {['all', 'active', 'completed', ...Object.keys(categoryIcons)].map((filter) => (
                        <button
                            key={filter}
                            ...
                            <div className="space-y-3 mb-4">
                                ...
                                {goal.targetDate && (
                                    <div className="flex items-center justify-between text-sm">
                                        ...
                                        <span className={`font-medium ${goal.isOverdue ? 'text-red-600' : 'text-gray-900 dark:text-white'}`}>
