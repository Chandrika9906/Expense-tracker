...
const Chatbot = () => {
    ...
    const [messages, setMessages] = useState([
        { role: 'assistant', text: 'Hi! I am your AI financial advisor. How can I help you today?', type: 'text' }
    ]);
    ...
    const handleSend = async (e) => {
        ...
        try {
            ...
            setMessages(prev => [...prev, { role: 'assistant', text, type: 'text' }]);
            ...
            setMessages(prev => [...prev, { role: 'assistant', text: "Sorry, I couldn't reach the server.", type: 'error' }]);
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const confirmAddExpense = async (expenseData) => {
        try {
            ...
            setMessages(prev => [...prev, { role: 'assistant', text: "Expense added successfully! ✅", type: 'success' }]);
                        ...
                        {messages.map((msg, idx) => (
                            <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                ...
                                >
                                    ...
                                    {/* Action UI */}
                                    {msg.type === 'action' && msg.actionType === 'ADD_EXPENSE' && (
