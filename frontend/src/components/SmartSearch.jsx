...
const SmartSearch = ({ onFiltersApplied, onClose }) => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (Object.keys(filters).length === 0) {
        toast.error(
          "Could not understand the query. Try examples like: 'Food expenses last month' or 'Expenses above 1000'.",
        );
        return;
      }
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-2xl max-h-[90vh] shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
              ...
              <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
                ...
                <li>
                  • Specify amounts: over 1000, under 500, between 100-500
                </li>
